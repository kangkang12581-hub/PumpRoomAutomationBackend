...
public class QueryNetWeightRequest
{
    [Required] public int SiteId { get; set; }
...
public class AggregatedNetWeightDto
{
...
public class NetWeightQueryResult
{
    public int SiteId { get; set; }
    ...
    public List<AggregatedNetWeightDto> Data { get; set; } = new();
